...
- [Badges Catalog](./references/badges-catalog.md) — Pre-compiled Shields.io templates, color codes, and license explanations.
- [Gitignore Templates](./references/gitignore-templates.md) — Ecosystem-specific `.gitignore` hardening rules.
- [Layout Templates](./references/layout-templates.md) — Modular README blueprints for Desktop Apps, Web Apps, Libraries, and CLI Tools.
